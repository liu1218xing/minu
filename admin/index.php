...
<body>
    <div class="head">
            ...
            <h3 class="head_text fr">咪奴后台管理系统</h3>
    </div>
                ...
                <ul class="mList">
                    <li>
                        ...
                        <dl id="menu2" style="display:none;">
                            <dd><a href="addmCate.php" target="mainFrame">添加分类</a></dd>
                            <dd><a href="listmCate.php?page=1" target="mainFrame">分类列表</a></dd>
                        </dl>
                    </li>
                    <li>
                        <h3><span onclick="show('menu1','change1')" id="change1">+</span>商品管理</h3>
                        <dl id="menu1" style="display:none;">
                        	<dd><a href="addmProduct.php" target="mainFrame">添加商品</a></dd>
                            <dd><a href="listmProduct.php" target="mainFrame">商品列表</a></dd>
                        </dl>
                    </li>
