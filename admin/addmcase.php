...
<body>
<h3>添加客户案例信息</h3>
<form action="doAdminAction.php?act=addmCase" method="post" enctype="multipart/form-data" >
<table width="90%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	<tr>
		<td align="right">案例标题</td>
		<td><input  type="text" name="aName"  placeholder="请输入案例标题"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="aSource"  placeholder="请输入案例来源"/></td>
	</tr>
	<tr>
		<td align="right">案例作者</td>
		<td><input type="text" name="aAuthor"  placeholder="请输入案例作者"/></td>
	</tr>
	<tr>
