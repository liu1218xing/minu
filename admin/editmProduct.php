...
<table width="90%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
		...
		<td><input type="text" name="ptitle"  value="<?php echo $proInfo['ptitle'];?>"/></td>
	</tr>
	<tr>
		<td align="right">keywords关键词</td>
		<td><input type="text" name="pkey"  value="<?php echo $proInfo['pkey'];?>"/></td>
	</tr>
	<tr>
		<td align="right">description关键词</td>
		<td><input type="text" name="pdescription"  value="<?php echo $proInfo['pdescription'];?>"/></td>
	</tr>
	<tr>
		<td align="right">商品摘要</td>
		<td><input type="text" name="psummary"   value="<?php echo $proInfo['psummary'];?>"/></td>
	</tr>
	...
	<tr>
		...
		<td>
			<textarea name="pDesc" id="editor_id" style="width:100%;height:350px;"><?php echo htmlspecialchars_decode($proInfo['pDesc']);?></textarea>
		</td>
	</tr>
