...
<table width="90%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
		...
		<td><input  type="text" name="aName"  placeholder="请输入文字标题"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="aSource"  placeholder="请输入文章作者"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="asummary"  placeholder="请输入商品摘要"/></td>
	</tr>
	<tr>
