...
<body>
<h3>添加商品</h3>
<form action="doAdminAction.php?act=editmCate&id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	<tr>
		<td align="right">分类排序号</td>
		<td><input type="text" name="sortid"  value="<?php echo $proInfo['sortid'];?>"/></td>
	</tr>
	...
	<tr>
		...
		<select name="parentid">
			<?php foreach($rows as $row):?>
				<option value="<?php echo $row['id'];?>" <?php echo $row['id']==$proInfo['parentid']?"selected='selected'":null;?>><?php echo $row['cName'];?></option>
			<?php endforeach;?>
		</select>
		</td>
	</tr>
	...
	<!-- <tr>
		...
		<td>
			<textarea name="pDesc" id="editor_id" style="width:100%;height:150px;"><?php echo htmlspecialchars_decode($proInfo['pDesc']);?></textarea>
		</td>
	</tr> -->
	<tr>
